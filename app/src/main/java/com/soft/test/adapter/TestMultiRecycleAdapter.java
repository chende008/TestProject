...
import com.soft.test.base.MultiRecycleAdapter;
...
public class TestMultiRecycleAdapter extends MultiRecycleAdapter<TestData, TestMultiRecycleAdapter.ViewHolder> {

    public TestMultiRecycleAdapter(Context context, List<TestData> list) {
        super(context, list);
    }
